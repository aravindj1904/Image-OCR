        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              <div className="h-10 w-10 bg-gradient-to-tr from-indigo-500 to-emerald-500 rounded-lg flex items-center justify-center text-white shadow-md">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-xs text-slate-500 font-medium tracking-wide">~ By Aravind Jagadeesh</span>
              </div>
            </div>
          </div>
        </div>
